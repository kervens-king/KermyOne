...
const ownerNumber = ['50942737567']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("KERVENS-XD~", '');
...
console.log("CONNECTING PATERSON-MD 🧬...");
...
console.log('PATERSON-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ PATERSON-MD-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
//================ownerreact==============
if(senderNumber.includes("50977777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("50942737567")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("50942737567")){
